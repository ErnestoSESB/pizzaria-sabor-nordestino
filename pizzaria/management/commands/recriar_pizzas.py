"""
Django management command para recriar todas as pizzas
"""
from django.core.management.base import BaseCommand
from pizzaria.models import Pizza

class Command(BaseCommand):
    help = 'Apaga e recria todas as pizzas'

    def handle(self, *args, **options):
        # Apagar todas as pizzas
        count = Pizza.objects.count()
        Pizza.objects.all().delete()
        self.stdout.write(self.style.WARNING(f'🗑️ {count} pizzas apagadas'))
        ...
        self.stdout.write(self.style.SUCCESS(f'\n✨ {len(pizzas)} pizzas recriadas com sucesso!'))
