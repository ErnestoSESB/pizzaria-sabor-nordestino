#!/usr/bin/env python
"""
Script para resetar pizzas no banco de dados Railway
Execute: python reset_pizzas_railway.py
"""
import os
import sys
import django
